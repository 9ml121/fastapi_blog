...
**更新时机**：
1. phase阶段开始前, 制定「当前phase阶段目标」和「待实现功能」
2. 开始子任务前，更新「下一步实施计划」
3. 完成子任务后，更新「已完成功能」和「遗留事项」，标记「待实现功能」

**归档时机**：phase阶段全部完成后，将「已完成功能」和「遗留事项」归档到`04-OVERVIEW.md`,并清空文件
