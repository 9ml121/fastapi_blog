...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "name", sa.String(length=50), nullable=False, comment="标签名称（唯一）"
        ),
        sa.Column(
            "slug", sa.String(length=100), nullable=False, comment="URL 友好的标识符"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "username", sa.String(length=50), nullable=False, comment="用户名（唯一）"
        ),
        sa.Column(
            "email", sa.String(length=100), nullable=False, comment="邮箱地址（唯一）"
        ),
        sa.Column(
        ...
        sa.Column(
            "avatar", sa.String(length=255), nullable=True, comment="头像文件路径"
        ),
        sa.Column(
            "role",
        ...
        sa.Column(
            "is_verified", sa.Boolean(), nullable=False, comment="邮箱是否已验证"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Text(),
            nullable=False,
            comment="文章正文内容（Markdown 格式）",
        ),
        sa.Column(
            "summary",
            sa.String(length=500),
            nullable=True,
            comment="文章摘要（用于列表页展示）",
        ),
        sa.Column(
            "slug",
    ...
    op.create_table(
        ...
        sa.Column(
            "ip_address", sa.String(length=45), nullable=True, comment="访问者IP地址"
        ),
        sa.Column(
            "user_agent",
            sa.String(length=500),
    ...
    op.create_index(
        "idx_post_viewed", "post_views", ["post_id", "viewed_at"], unique=False
    )
    op.create_index(
        "idx_user_viewed", "post_views", ["user_id", "viewed_at"], unique=False
    )
    op.create_index(
        op.f("ix_post_views_post_id"), "post_views", ["post_id"], unique=False
    )
    op.create_index(
        op.f("ix_post_views_user_id"), "post_views", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_post_views_viewed_at"), "post_views", ["viewed_at"], unique=False
    )
